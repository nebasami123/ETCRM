...
import type { Activity, AdminLeadForm, AdminSummary, Lead, LeadFilters, Quota, SalesUserForm, UploadResult, UserSummary } from "../../../types";
...
export const adminApi = {
  ...
  createLead: (payload: Omit<AdminLeadForm, "assignedToId"> & { assignedToId: string | null }) => api.post("/admin/leads", payload).then((res) => res.data),
