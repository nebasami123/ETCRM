  ...
  return (
    <section className="rounded-lg border border-line bg-white shadow-soft">
      <div className="border-b border-line p-5">
        ...
        <p className="text-sm text-neutral-500">Your private work queue: appointments, follow-ups, and new claimed leads.</p>
        <input
          value={leadSearch}
      ...
      <div className="max-h-[680px] overflow-y-auto">
        {visibleActiveList.map((lead) => (
          ...
          >
            ...
            <p className="text-xs text-neutral-500">Follow-up: {formatDate(lead.nextFollowUpAt)}</p>
          </button>
        ))}
      </div>
    </section>
